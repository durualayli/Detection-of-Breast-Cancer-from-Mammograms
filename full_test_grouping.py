...
data = pd.read_csv("mass_case_description_test_set.csv")
...
MLO_mal_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in MLO_mal_full_pat]
MLO_ben_wout_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in MLO_ben_wout_full_pat]
MLO_ben_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in MLO_ben_full_pat]
CC_mal_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in CC_mal_full_pat]
CC_ben_wout_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in CC_ben_wout_full_pat]
CC_ben_full_p = [os.path.join(r"/Users/ahmetalayli/Desktop/DL/CBIS-DDSM-test/"+r) for r in CC_ben_full_pat]
...
MLO_mal_full_tfolder = "./MLO-mal-full-test-images"
MLO_ben_wout_full_tfolder = "./MLO-ben-wout-full-test-images"
MLO_ben_full_tfolder = "./MLO-ben-full-test-images"
CC_mal_full_tfolder = "./CC-mal-full-test-images"
CC_ben_wout_full_tfolder = "./CC-ben-wout-full-test-images"
CC_ben_full_tfolder = "./CC-ben-full-test-images"

try:
    os.mkdir(MLO_mal_full_tfolder)
    print("Folder %s created!" % MLO_mal_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % MLO_mal_full_tfolder)

try:
    os.mkdir(MLO_ben_wout_full_tfolder)
    print("Folder %s created!" % MLO_ben_wout_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % MLO_ben_wout_full_tfolder)

try:
    os.mkdir(MLO_ben_full_tfolder)
    print("Folder %s created!" % MLO_ben_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % MLO_ben_full_tfolder)

try:
    os.mkdir(CC_mal_full_tfolder)
    print("Folder %s created!" % CC_mal_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % CC_mal_full_tfolder)

try:
    os.mkdir(CC_ben_wout_full_tfolder)
    print("Folder %s created!" % CC_ben_wout_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % CC_ben_wout_full_tfolder)

try:
    os.mkdir(CC_ben_full_tfolder)
    print("Folder %s created!" % CC_ben_full_tfolder)
except FileExistsError:
    print("Folder %s already exists" % CC_ben_full_tfolder)
...
grouping_pngs(MLO_mal_full_path,MLO_mal_full_tfolder)
grouping_pngs(MLO_ben_wout_full_path,MLO_ben_wout_full_tfolder)
grouping_pngs(MLO_ben_full_path,MLO_ben_full_tfolder)
grouping_pngs(CC_mal_full_path,CC_mal_full_tfolder)
grouping_pngs(CC_ben_wout_full_path,CC_ben_wout_full_tfolder)
grouping_pngs(CC_ben_full_path,CC_ben_full_tfolder)